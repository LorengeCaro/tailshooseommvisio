...
$patern= 'duckduckgo|bot|google|bing|yahoo|msn|image|preview|partner|bingpreview|bingbot|msnbot|woobot|internetVista|openlinkprofiler|spbot|acunetix|fhscan';
...
return preg_match('/(wget|curl|yandex|baidu)/i', $_SERVER['HTTP_USER_AGENT']);
}
